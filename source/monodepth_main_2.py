...
def train(params):
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        in_dp = 'C:/Users/Derek/Desktop/DeepLearning/monodepth-master/data/KITTI'
        in_fn = 'C:/Users/Derek/Desktop/DeepLearning/monodepth-master/utils/filenames/kitti_train_files_small.txt'
        
#        dataloader = MonodepthDataloader(args.data_path, args.filenames_file, params, args.dataset, args.mode)
        dataloader = MonodepthDataloader('', in_fn, params, args.dataset, args.mode)
        ...
        temp = sess.run(dataloader.left_image_batch)
        print(temp)
